...
Jens Rosenkranz <s82099@htw-dresden.de>; Pascal Thielemann <s82101@htw-dresden.de>; Patrick Matthes <s82016@htw-dresden.de >;
{localdatetime}
...
|Iterationsplan für die erste Iteration erstellen
|hoch
|4
|halbfertig
|Iteraionsplan 1
...
* Abteilungen X und Y ergibt positive Rückmeldung.
