...
* Iterationsplan für die erste Iteration wird erstellt
...
| x | x | x | x | x | x | x | x | x 
|Terminfindung für gesamtes Team + Betreuer
|hoch
|2
|erledigt
|-
...
|2
|1
|Terminvereinbarung mit Auftraggeber|hoch|2|erledigt|-|1|Jakob Häcker|2|0
|Herstellung Visionsdokument|hoch|4|halbfertig|Vision|1|Jens Rosenkranz|4|2
|Projektplan erstellen|hoch|4|unbearbeitet|Projektplan|1|-|-|
|Iterationsplan für die erste Iteration erstellen|hoch|4|halbfertig|Iteraionsplan 1|1|Jens Rosenkranz|3|
|Glossar erstellen|niedrig||||1||
||||||1||
|===
...
| Terminfindung zum gemeinsamen Treffen aller Teammitglieder unmöglich | ungelöst | Auf Grund der Unterschiedlichen Stundenpläne der Teammitglieder aus verschiedenenen Studiengänge, die zu dem zwischen gerade und ungeraden Wochen alternieren, war es nicht möglich einen gemeinsamen regelmäßigen Termin zu finden
|X|X|X
|===
