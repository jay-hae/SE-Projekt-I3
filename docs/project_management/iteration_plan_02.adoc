= Iteration Plan 02: Datenbank Webverwaltung Stabsstelle Internationales
Jens Rosenkranz <s82099@htw-dresden.de>; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>; Luca Meißner <s82091@htw-dresden.de>; Jakob Häcker <s82048@htw-dresden.de>;
{localdatetime}
...
|Verfeinerung von Use Cases für die Hauptfunktionalitäten, ggf. inkl. Aktivitätsdiagrammen und Wireframes 
|20.01.2021

|Verfeinerung von Vision
|20.01.2021

|Verfeinerung Glossar
|20.01.2021

|Verfeinerung Supplementary Specs
|20.01.2021

| Ende der Iteration | 28.01.2021
|===
...
* Erarbeitung der Use Cases für die Hauptfunktionalitäten, ggf. inkl. Aktivitätsdiagrammen und Wireframes 
* Lösungsweg zur Bereitstellung der Hauptfunktionen erarbeitet
* Präsentation der Ergebnisse der ersten beiden Iterationen
