...
|Use Cases für die Hauptfunktionalitäten im Detail beschrieben, ggf. inkl. Aktivitätsdiagrammen und Wireframes 
|20.01.2021

|Vision ist vollständig und detailliert ausgearbeitet
|20.01.2021
...
* Verfeinerung von Use Cases, Vision, Glossar und SupplementarySpec.
