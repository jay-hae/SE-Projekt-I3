...
Um einen Überblick über die akut bzw. in der akutellen Iteration zu erledigenden Aufgaben zu behalten pflegt der Teamleiter Luca Meißner ein Excel-Dokument als Work-Items-Liste.
...
HIER BILD VON AKTUELLEN ESSENCE NAVIGAOR TORTENDIAGRAMM EINFÜGEN
