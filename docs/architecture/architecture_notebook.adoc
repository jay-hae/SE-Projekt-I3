...
.. Die genutzten Frameworks (Flask, jQuery) müssen von Hersteller regelmäßig geplegt werden.
...
** MySQL ähnlich zu MSSQL, mit dem einige Gruppenmitglieder schon Erfahrung haben
