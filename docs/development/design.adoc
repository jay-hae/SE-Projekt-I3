...
Als Webserver dient eine virtuelle Maschine, welche vom Rechenzentrum bereitgestellt wird. Dort läuft das Backend in Python und das Frontend mithilfe von HTML, CSS und Javascript.
...
* Ein Button zum Bearbeiten für jeden Datensatz (ausgenommen Studiengänge, Fakultäten & Länder)
