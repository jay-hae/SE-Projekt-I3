...
== Einführung
Um das Projekt im Groben einordnen zu können, ist es wichtig sich mit den Rahmenbedingungen des Projektes vertraut zu machen.
...
| Bereitstellen von Informationen für Externe
| 5 
