...
Hochschulpartnerschaften zur Pflege der Daten der Hochschul-Partnerschaften zu etablieren. Sowie eine automatisierte Berichtsanfertigung, eine zuverlässige Schnittstelle zum Informationsfrontend zu gewährleisten und evtl.Weiterentwicklungsmöglichkeiten bereit zustellen.
|===
...
| Unser Produkt | ermöglicht eine komfortable Form der Datenbankverwaltung im Mehrbenutzer betrieb.
|===

[cols="1,3"]
|===
| Für | Externe
| die | sich über Partner-Hochschulen und Austausch-Programme interessieren.
| Das Produkt stellt eine | Schnittstelle für eine Webanschicht von ausgewählten Daten aus der Maria-Datenbank zur Verfügung, welche auf der HTW-Webseite betrachtet werden können.
|===
////
Beispiel Produkt:
|===
