...
*SWFA-1: Das System muss mit der bereits bestehenden Datenbankstruktur kompatibel sein.*

*SWFA-2: Das System muss alle Hochschulpartnerschaften und Statistiken persistent speichern.*

** Zur Überprüfung wird die Seite neu geladen.

*SWFA-3: Das System darf nur beschränkten Zugriff auf die Daten/das System bereitstellen, sodass nur autorisierte Mitarbeiter des Akademischen Auslandsamtes Zugriff auf das Verwaltungsfrontend haben.*
...
*SWFA-4: Das Interface des Systems ist je nach Nutzer unterschiedlich. Einige Funktionen können nur von bestimmten Nutzern durchgeführt werden.*
