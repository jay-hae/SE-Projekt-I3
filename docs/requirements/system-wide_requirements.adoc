...
*SWFA-1: Das System muss mit der bereits bestehenden Datenbankstruktur funktionieren.*
...
*SWFA-3: Nur autorisierte Mitarbeiter des Akademischen Auslandsamtes dürfen Zugriff auf das Verwaltungsfrontend haben.*
