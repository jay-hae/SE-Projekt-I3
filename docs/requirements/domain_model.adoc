...
Das Domain Model bildet die relevante Terminologie der Fachdomäne ab, mit dem Ziel, eine
gemeinsame Sprache zwischen Entwicklern und Fachexperten herzustellen und
