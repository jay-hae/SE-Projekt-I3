...
| Bestandsdaten | Attribute der Hochschule | -- 
...
| Flask | eine in Python geschriebene Anwendung, die zur Erweiterung und guter Dokumentation dient | --
...
| Kontaktperson | Person über die eine ausländische Hochschule kontaktiert werden kann, um einen Partnerschaftsvertrag einzuleiten | --
...
| Prototype | Vereinfachtes Modell eines geplanten Produktes | erste Bildung, Urbild
...
| responsive Webdesign | gestalterischer und technischer Prototype | reagierendes Webdesign
...
| Verwaltungsfrontend | Das Frontend, das von der Stabstelle Internationales genutzt wird, um die Hochschulpartnerschaften zu verwalten | Frontend für die Stabstelle Internationales (Verwaltungsanwendung)
