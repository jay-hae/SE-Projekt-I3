...
| Akademisches Auslandsamt | Stabsstelle Internationales | --
...
| Incoming | Studierende aus dem Ausland, die zeitweise an der HTW-Dresden studieren | An die Hochschule kommende ausländische Studenten
...
| Outgoing | Studierende der HTW, die an einem Austauschprogramm zu einer ausländischen Hochschule teilnehmen | Von der Hochschule gehende Studenten
...
//| Verwaltungsfrontend | Für den Nutzer sichtbarerer Teil der Software, der von der Stabsstelle Internationales genutzt wird, um die Hochschulpartnerschaften zu verwalten | Frontend für die Stabsstelle Internationales (Verwaltungsanwendung)
...
| MSI | Mitarbeiter oder Leitungsperson der Stabsstelle Internationales | Hauptnutzer der Software
...
| SI | Stabsstelle Internationales | Auftraggeber des Softwareprojektes
