...
| Erasmus
| Externe | Besucher des Informationsfrontends | Studierende, Mitarbeiter, Interressierte Personen

| Department | Auslandsbüro an einer
Hochschule | Abteilung

| Fakultät | eine Gruppe zusammengehörender Wissenschaften oder Wissenschaftsgebiete umfassende Abteilung als Lehr- und Verwaltungseinheit einer Universität oder Hochschule | (keine)
...
| International Office | Abteilung einer ausländischen Hochschule, die für die Kommunikation in Angelegenheiten von Austauschstudierenden und Partnerschaftsverttägen zuständig ist. | (keine)

| Kontaktperson | Person über die eine ausländische Hochschule kontaktiert werden kann, um einen Partnerschaftsvertrag einzuleiten | (keine)
...
| Mitarbeiter | Person oder Grupper, welche bei der Stabsstelle Internationales arbeitet | normaler User, SI Mitarbeiter
...
| Datenbank| System zur elektronischen Datenverwaltung, welches einen Mehrbenutzerzugriff erlaubt | (keine)
...
| HTW | Hochschule | Hoschule für Technik und Wirtschaft Dresden
