...
// ...
Im folgenden werden die bisher identifizierten Use Cases benannt. Die 5 wichtigsten werden detailiert beschreiben.
...
* <<_uc06_erstellen_von_berichten_über_erasmusvereinbarungen>>
* <<_uc07_erstellen_von_berichten_über_mentoren>>
* <<_uc08_erstellen_von_berichten_über_hochschulvereinbarungen>>
* <<_uc09_erstellen_von_berichten_über_abkommen_nach_länder_sortiert>>
* <<_uc10_berichte_exportieren>>
* <<_uc11_externe_abfragen>>
...
==== *UC04*: Fehlerhafte Datensätze Löschen
...
==== *UC06*: Berichte über Erasmusvereinbarungen Erstellen
//include::use_case_06.inc.adoc[lines=1..1;4..-1,leveloffset=+1]

==== *UC07*: Berichte über Mentoren Erstellen
//include::use_case_07.inc.adoc[lines=1..1;4..-1,leveloffset=+1]

==== *UC08*: Berichte über Hochschulvereinbarungen Erstellen
//include::use_case_08.inc.adoc[lines=1..1;4..-1,leveloffset=+1]

==== *UC09*: Berichte über Abkommen nach nach Länder sortiert Erstellen
//include::use_case_09.inc.adoc[lines=1..1;4..-1,leveloffset=+1]

==== *UC10*: Erstellte Berichte Exportieren
//include::use_case_10.inc.adoc[lines=1..1;4..-1,leveloffset=+1]

==== *UC11*: Berichte für Externe Anzeigen 
//TODO UC11 umbenennen
//include::use_case_11.inc.adoc[lines=1..1;4..-1,leveloffset=+1]
