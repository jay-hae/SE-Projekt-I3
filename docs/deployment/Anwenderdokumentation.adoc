...
=== Use-Case: Use-Case: Mentoren Editieren (UC05)
...
=== Wie kann ich eine Partnerhochschule oder einen Vertrag löschen?
...
=== Wie kann ich eine neue Fakultät, einen Studiengang oder ein Geschlecht anlegen?
