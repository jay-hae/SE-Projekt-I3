...
|NFAP-1: Der Wechsel zwischen den Reitern des Verwaltungsfrontends sollte maximal 3 Sekunden dauern | Ja | Ist erfüllt. Es wurden deutlich schnellere Zeiten beim Testen festgestellt.
|NFAP-2: In mindestens 90% der Fälle sollen Datenbank relevante Funktionen in 2 Sekunden ausgeführt sein. | Ja | Ist erfüllt. Es wurden deutlich schnellere Zeiten beim Testen festgestellt.
