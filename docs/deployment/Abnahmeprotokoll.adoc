...
|SWFA-2: Nur autorisierte Mitarbeiter des Akademischen Auslandsamtes dürfen Zugriff auf das Verwaltungsfrontend haben. | Ja  | Im prinzip alle, die über die Anmeldedaten der Datenbank verfügen.
...
|NFAP-1: Der Wechsel zwischen den Reitern des Verwaltungsfrontends sollte maximal 3 Sekunden dauern | Ja | Es gab keinen Test, in dem das Gegenteil der Fall war.
|NFAP-2: In mindestens 90% der Fälle sollen Datenbank relevante Funktionen in 2 Sekunden ausgeführt sein. | Ja | Es gab keinen Test, in dem das Gegenteil der Fall war.
