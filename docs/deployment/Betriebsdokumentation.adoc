...
Hier wird nur die Funktionsweise und Installation auf einer, vom Laborbereich der Fakultät Informatik, bereitgestellten Virtuellen Maschine gezeigt. Dies ist gleich bedeutend mit einer Installation auf einer, vom Rechenzentrum bereitgestellten, Virtuellen Maschine.
