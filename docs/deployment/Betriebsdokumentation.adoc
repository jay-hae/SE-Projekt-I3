...
Das Hauptaugenmerk unseres Projektes ist es ein Web Frontend unter Nutzung einer gegebenen Datenbank zu erstellen. 

Aus diesem Grund werden Datenbank spezifische Erläuterungen nicht vorgenommen. 
...
=== Verbindung auf die Virtuelle Maschine 
